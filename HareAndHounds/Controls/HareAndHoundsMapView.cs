...
namespace HareAndHounds
{
    ...
    public class HareAndHoundsMapView : View
{
        ...
        public HareAndHoundsMapView(Context context)
            : base(context)
        {
            Initialize();
        }

        public HareAndHoundsMapView(Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
            Initialize();
        }

        public HareAndHoundsMapView(Context context, IAttributeSet attrs, int defStyle)
